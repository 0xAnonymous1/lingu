  ...
  studyGroups: [
    {
      ...
      online: 5,
      description:
        "Practice basic Spanish conversations and help each other learn!",
      ...
      messages: [
        {
          ...
          userCountry: "🇲🇽",
          message:
            '¡Hola everyone! How do you say "I am excited to learn" in Spanish?',
        ...
        },
        {
          ...
          userCountry: "🇺🇸",
          message:
            '"Estoy emocionado/a de aprender" - the ending depends on your gender!',
  ...
  try {
    ...
    if (savedState) {
      ...
      return {
        ...
        lessonProgress: Array.isArray(parsedState.lessonProgress)
          ? parsedState.lessonProgress
          : [],
        studyGroups: Array.isArray(parsedState.studyGroups)
          ? parsedState.studyGroups
          : defaultInitialState.studyGroups,
        achievements: Array.isArray(parsedState.achievements)
          ? parsedState.achievements
          : defaultInitialState.achievements,
        settings: { ...defaultInitialState.settings, ...parsedState.settings },
        callHistory: Array.isArray(parsedState.callHistory)
          ? parsedState.callHistory
          : [],
      };
    }
  } catch (error) {
    ...
    case "UPDATE_LESSON_PROGRESS": {
      ...
      const updatedProgress = existingProgress
        ? state.lessonProgress.map((p) =>
            p.lessonId === action.lessonId ? newProgress : p
          )
      ...
      const newStreak =
        action.score >= 70 ? state.user.streak + 1 : state.user.streak;
